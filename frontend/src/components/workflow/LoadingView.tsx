...
const MESSAGES = [
  {
    cn: "正在分析您的流程描述...",
    en: "Analyzing your workflow description...",
  },
  {
    cn: "正在识别流程节点和依赖关系...",
    en: "Identifying process nodes and dependencies...",
  },
  {
    cn: "正在对标行业最佳实践...",
    en: "Benchmarking against industry best practices...",
  },
  {
    cn: "正在生成优化建议...",
...
export default function LoadingView() {
  ...
  return (
    ...
    >
            ...
            >
              ...
              <div
                style={{
                  ...
                  border: `2px solid ${isActive ? AC : BD}`,
                  transition: "all 0.4s ease",
                  opacity: isActive ? 1 : 0.3,
                  boxShadow: isActive ? `0 0 10px ${AC}40` : "none",
                }}
              />
              ...
              {i < NODE_COUNT - 1 && (
                <div
                  style={{
                    ...
                    opacity: i < activeNodes - 1 ? 0.7 : 0.2,
                  }}
                />
              )}
            </div>
      ...
      >
        <div style={{ fontSize: 18, color: TX, fontWeight: 500 }}>
          {msg.cn}
        </div>
        <div style={{ fontSize: 14, color: T2, marginTop: 6 }}>
          {msg.en}
        </div>
      </div>
