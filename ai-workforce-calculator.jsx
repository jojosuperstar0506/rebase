...
const NEXT_STEPS = {
  ...
  2: { action: "解决'买了没用'问题", detail: "工具买了不等于用了。需要专业指导找到正确切入点，才能让团队真正用起来" },
...
// Tier progression target descriptions
const TIER_TARGETS = {
  1: "选定试点部门，完成首个AI工具部署",
...
export default function App() {
  ...
  // Tier progression: current → +1 level (3-6mo) → +2 levels (12-18mo), capped at L5
  ...
  const currentAnnualCost = results.reduce((s, r) => {
    return s + r.rr.reduce((rs, role) => rs + role.salary * role.cc * 14, 0);
  }, 0);
    ...
    return (
      <div style={{ ...cd, padding: "16px 14px", flex: 1, position: "relative", overflow: "hidden", opacity: isNow ? 0.85 : 1 }}>
        ...
        <div style={{ marginBottom: 8 }}>
          <span style={{ display: "inline-block", padding: "3px 10px", borderRadius: 4, fontSize: 12, fontWeight: 700, color: c, background: darkMode ? stage.tierDef.bgDark : stage.tierDef.bg }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "36px 20px" }}>
        ...
        <div style={{ ...cd, marginBottom: 20, padding: "16px 20px", background: `${overallTier.color}08`, borderColor: `${overallTier.color}25` }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: overallTier.color, marginBottom: 4 }}>
            下一步行动：{NEXT_STEPS[overallTier.level]?.action}
          </div>
          <div style={{ fontSize: 12, color: T.textSecondary, lineHeight: 1.6 }}>
            {NEXT_STEPS[overallTier.level]?.detail}
          </div>
        </div>
                  ...
                  <div style={{ padding: "0 16px 16px", borderTop: `1px solid ${T.border}` }}>
                    ...
                    <div style={{ margin: "12px 0", background: T.cardBgAlt, borderRadius: 6, padding: "12px 14px" }}>
                      ...
                      <div style={{ display: "flex", gap: 8, marginBottom: 8, flexWrap: "wrap" }}>
                        <div style={{ flex: 1, minWidth: 120, background: darkMode ? "#1a1a2e" : "#F9FAFB", borderRadius: 4, padding: "8px 10px", border: `1px solid ${T.border}` }}>
                        ...
                        {gapScore > 0 && (
                          <div style={{ flex: 1, minWidth: 120, background: darkMode ? "#1a1a2e" : "#FEF2F2", borderRadius: 4, padding: "8px 10px", border: `1px solid ${T.negative}20` }}>
                    ...
                    {/* Section 2: What's Possible (headcount + savings) */}
                    <div style={{ margin: "10px 0", background: T.cardBgAlt, borderRadius: 6, padding: "12px 14px" }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6, marginBottom: 8 }}>
                        <div style={{ textAlign: "center", padding: "8px 4px", borderRadius: 4, background: darkMode ? "#1a1a2e" : "#F9FAFB", border: `1px solid ${T.border}` }}>
                      ...
                      <div style={{ display: "flex", gap: 8 }}>
                        <div style={{ flex: 1, background: darkMode ? "#1a1a2e" : "#F0FDF4", borderRadius: 4, padding: "6px 10px", border: `1px solid ${T.positive}20` }}>
                          <div style={{ fontSize: 10, color: T.textMuted }}>年度可释放资源</div>
                    ...
                    {/* Section 3: Rebase CTA — Gate the "How" */}
                    <div style={{ margin: "10px 0", background: `${T.accent}08`, borderRadius: 8, padding: "16px", border: `1px solid ${T.accent}30`, position: "relative", overflow: "hidden" }}>
                      ...
                      <div style={{ fontSize: 13, fontWeight: 700, color: T.accent, marginBottom: 10 }}>
                        解锁「{dept.name}」完整AI升级方案
                      </div>
                      <div style={{ fontSize: 12, color: T.textSecondary, lineHeight: 1.8, marginBottom: 12 }}>
                        Rebase顾问将为您的团队量身定制：
                      </div>
                      ...
                      <button
                        onClick={() => {
                          const el = document.getElementById("rebase-cta-form");
                          if (el) el.scrollIntoView({ behavior: "smooth" });
                        }}
                        style={{
                          width: "100%", padding: "10px 20px", fontSize: 13, fontWeight: 600, borderRadius: 6,
                          border: "none", background: T.accent, color: "#FFFFFF", cursor: "pointer",
        ...
        {/* CTA */}
        <div id="rebase-cta-form" style={{ ...cd, marginTop: 12, textAlign: "center", borderTop: `3px solid ${T.accent}` }}>
          <div style={{ fontSize: 16, fontWeight: 700, marginBottom: 4, color: T.text }}>让Rebase帮你把诊断变成落地方案</div>
          <p style={{ fontSize: 12, color: T.textSecondary, marginBottom: 14, lineHeight: 1.6 }}>每个部门的AI升级路径不同。我们提供1v1指导，帮你的团队真正用起来。</p>
          {!leadSubmitted ? (
